process ASSEMBLE_EMPIRICAL_LIBRARY {
    ...
    path "calibrated_params.txt", emit: calibrated_params
    ...
    # Parse calibrated mass accuracy and scan window from the log
    ...
    echo -n "\${val_mass_acc_ms2},\${val_mass_acc_ms1},\${val_scan_window}" > calibrated_params.txt
