...
| -------------------- | ----------------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--input`            | string (file-path)      | _required_  | URI/path to an SDRF file with `.sdrf.tsv` extension. Parameters such as enzyme, fixed modifications, and acquisition method are read from the SDRF.                                                                        |
